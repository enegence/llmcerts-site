...
@font-face {
  ...
  src: url("https://notion.so/_next/static/media/LyonText-Regular-Web.d7bfb4be.woff2") format("woff2");
  font-weight: 400;
}
@font-face {
  font-family: "iA Writer Mono";
  src: url("https://notion.so/_next/static/media/iAWriterMonoS-Regular.bf09337b.woff2") format("woff2");
  font-weight: 400;
}
@font-face {
  font-family: "Permanent Marker";
  src: url("https://notion.so/_next/static/media/permanent-marker.18b85f55.woff") format("woff");
  font-weight: 400;
}
```
